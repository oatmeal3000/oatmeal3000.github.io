...
Crafty.scene('Victory', function(){
  ...
  // Draw some text for the player to see in case the file
  //  takes a noticeable amount of time to load
  Helpers.centeredText("祝贺!");
  Helpers.centeredText("点击去下一个板栗仔的栖息地!", { y_offset: 30 });
...
Crafty.scene('Final', function(){
  // Draw some text for the player to see in case the file
  //  takes a noticeable amount of time to load
  Helpers.centeredText("你完成了所有的关卡!");
  Helpers.centeredText("返回给所有关卡找到更好的解决方案!", { y_offset: 30 });
});
...
Crafty.scene('Start', function() {
  ...
  Helpers.simpleText('点击开始', { x: 450, y: 310, width: 200, css: { color: 'black' } });
