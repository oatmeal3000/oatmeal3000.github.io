    ...
    switch (map[i]) {
      ...
      default:
        ...
        switch (map[i]) {
          ...
          case "e": charTile = Tile.RoofWest; break;
          case "a": charTile = Tile.RoofEast; break;
          case "s": charTile = Tile.RoofNorth; break;
          case "n": charTile = Tile.RoofSouth; break;
          case "c": charTile = Tile.RoofNorthWest; break;
          case "z": charTile = Tile.RoofNorthEast; break;
          case "r": charTile = Tile.RoofSouthWest; break;
          case "q": charTile = Tile.RoofSouthEast; break;
          ...
          case "b": charTile = Tile.Brown; break;
          case "o": charTile = Tile.DoorClosed; break;
          case "O": charTile = Tile.DoorOpen; break;
          case "B": charTile = Tile.Bug; break;
          case "H": charTile = Tile.Heart; break;
          case "K": charTile = Tile.Key; break;
          case "t": charTile = Tile.TreeShort; break;
          case "T": charTile = Tile.TreeTall; break;
          case "A": charTile = Tile.PushTall; break;
          case "D": charTile = Tile.Wood; break;
          
          case "u": charTile = Tile.WindowShort; break;
          case "I": charTile = Tile.Princess; break;
          case "S": charTile = Tile.StoneTall; break;
