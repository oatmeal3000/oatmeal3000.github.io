...
var HintType = {
  None: '没有',
  RowsMustBeUnique: '两个行不能一样',
  ColsMustBeUnique: '两个列不能一样',
  RowMustBeBalanced: '每一行需要两个颜色的方片数量都一样',
  ColMustBeBalanced: '每一列需要两个颜色的方片数量都一样',
  MaxTwoRed: '三个红色的方片不能连在一起',
  MaxTwoBlue: '三个蓝色的方片不能连在一起',
  SinglePossibleRowCombo: '只有一种组合在这儿是可能的',
  SinglePossibleColCombo: '只有一种组合在这儿是可能的',
  Error: '这个看起来不太对啊',
  Errors: '这些看起来不太对'
};
