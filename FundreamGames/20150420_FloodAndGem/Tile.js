...
(function () {
  ...
  Tile = {
    ...
    Brown: _Tile("Brown", {shadow:true}),
    DoorClosed: _Tile("DoorClosed", {shadow:true}),
    DoorOpen: _Tile("DoorOpen", {shadow:false}),
    Bug: _Tile("Bug", {shadow:false}),
    Heart: _Tile("Heart", {shadow:false}),
    Key: _Tile("Key", {shadow:false}),
    TreeTall: _Tile("TreeTall", {shadow:false}),
    TreeShort: _Tile("TreeShort", {shadow:false}),
    PushTall: _Tile("PushTall",{shadow:true}),
    Wood: _Tile("Wood", {shadow:true}),
    StoneTall: _Tile("StoneTall", {shadow:true}),
    Princess: _Tile("Princess", {anyFloodable:true,shadow:false}),
    ...
    WindowShort: _Tile("WindowShort", {shadow:false})
  };  
})();
