...
function createGame(holderQuerrySelector, difficultySetting) {
    ...
    function gameOver() {
        ...
        setTimeout(function () {
            ...
            gameoverDiv.innerHTML = '您的得分：' + Math.round(score) + '<br/><br/><a href="javascript:location.reload()" style="text-decoration:none"><font color="white">重玩</a><br/>';
            gameoverDiv.style.display = 'block';
            document.title = '我今天玩大脑空间得了' + Math.round(score) + '分';
        },3400);
